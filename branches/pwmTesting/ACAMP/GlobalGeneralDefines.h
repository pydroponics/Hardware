...
/**
 * Function: LED
 * @param condition, Status desired for board LED.
 * @return NONE
 * @remark Turns the board LED on or off
 */
void LED(int condition);
