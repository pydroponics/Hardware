 ...
 * PRIVATE VARIABLES                                                           *
 ******************************************************************************/
static unsigned int timerArray[NUM_TIMERS];
...
Description:
	...
	appropriate location in timerArray to countTime.
...
char sysTimerInit(unsigned char timerIndex, unsigned int countTime) {
    ...
    timerArray[timerIndex] = countTime;
